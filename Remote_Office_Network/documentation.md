...
- [Networking Lab | Project 17  Documentation](#networking-lab--project-17--documentation)
    ...
    - [Spanning Tree (STP) Configurations :](#spanning-tree-stp-configurations-)
    - [HSRP (Hot Standby Router Protocol) Configuration :](#hsrp-hot-standby-router-protocol-configuration-)
    - [Routing Protocol](#routing-protocol)
    - [VPN Configuration](#vpn-configuration)
    - [Wireless LAN Controller (WLC) Setup](#wireless-lan-controller-wlc-setup)
...
**NB**: See the [project file](Project_17pkt) for indepth addressing details as VRLSM was used where neccessary  
...
### Spanning Tree (STP) Configurations :  
...
but active for VLANs 40,50,60
  ...
  **NB:** This setup enables HQ DSW1 to serve as the active router for VLANs 10, 20, and 30, while HQ DSW2 serves as standby for those VLANs and vice versa for VLANs 40, 50, and 60, achieving the intended redundancy and load balancing across VLANs.
    ...
    [Verify HSRP on HQDSW1](HQHSV1.jpg)  
    [Verify HSRP on HQDSW2](HQHSV2.jpg)
...
See Exec Staff PC [pinging](VPNHQ.jpg) Branch 1 Finance PC. For detailed configuration, refer to the [project file](project_17.pkt) 
